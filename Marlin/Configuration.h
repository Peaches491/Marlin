...
#define STRING_CONFIG_H_AUTHOR "(Daniel Miller, Mendel 90 Config)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 200.0*4*4/5, 400 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 2500, 100, 6000 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     44      // LED driving pin
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS  69      // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
